...
module.exports = class PM{
    ...
    message(nick, text){
        ...
        //respond to command
            ...
            var command_data = b.cmds.command(command, fake_user);
            ...
            b.cmds.verify_command(fake_user, command, {help: true, is_pm: true}, function(cmd){
                if(cmd !== false){

                     var command_args = b.cmds.parse_command_input(fake_user, _this, command, command_str);
