...
module.exports = class USER{
    ...
    set_user_modes(){
        var _this = this;
        _this.log.debug('SET USER MODES', _this.nick);
        if(this.chan !== 'PM'){
            b.users.user_data_from_who(_this.config.chan_owner, true, function(chan_owner_regex){
                if(_this.who.match(chan_owner_regex) !== null){
                    ...
                    b.log.debug(_this.nick, 'is_op', b.is_op, 'make_owner_chan_owner', _this.config.make_owner_chan_owner, 'perm', _this.perm);
