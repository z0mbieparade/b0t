    ...
    say(){
        ...
        function check_chan_busy_status(callback){
            b.users.owner(false, function(owner_nicks){
                if(options.ignore_bot_speak === false &&
                   ...
                   (owner_nicks.indexOf(options.to) < 0 || owner_nicks === null) && 
                   options.is_pm === false){ 
        ...
        function update_chan_speak_status(){
            b.users.owner(false, function(owner_nicks){
                if(options.ignore_bot_speak === false &&
                   options.is_cmd === true && 
                   (owner_nicks.indexOf(options.nick) < 0 || owner_nicks === null) && 
                   options.is_pm === false){
        ...
        function check_busy(callback){
            db.get_data("/speak/"+_this.chan+'/chan', function(msg_arr){
