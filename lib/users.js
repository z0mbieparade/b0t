...
module.exports = class USERS{
    constructor(){
		...
		this.finish_nicklist_callback = function(){

		}
	}

	nickserv_check_list(nicks){
		var _this = this;
        ...
        if (_this.nicks_check_info_queue.length > 0 || times.length > 0){
        	var pause = setTimeout(function(){
	    		clearTimeout(pause);
	    		_this.nickserv_check_list([]);
	    	}, 100);
        } else {
        	_this.finish_nicklist_callback(function(){
    			_this.finish_nicklist_callback = function(){};
    		});
        }
	}
