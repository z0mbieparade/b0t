			...
			nicks.forEach(function(nick){
				...
				_this.get_user_data(nick, {
					...
					if(!last_seen && !last_spoke){
                        ...
                        b.log.warn('autokb', nick, 'has never said anything: autokb_new_user_threshold', kb_inactive_for);
                    	...
                    	b.log.warn('autokb', nick, 'has not spoken in over: autokb_users_inactive_for', kb_inactive_for);
