...
module.exports = class USERS{
	...
	nickserv_check_list(nicks, chan, cb_name){
		...
		b.log.debug('2 info_queue', _this.nicks_check_info_queue.join(', '), 'awaiting_queue', _this.nicks_awaiting_info_queue);
        ...
        if(_this.nicks_check_info_queue.length > 0)
        {
        	...
        	if(_this.nicks_awaiting_info_queue[nick] !== undefined){
	            b.log.debug('3 (add to awaiting queue) info_queue', _this.nicks_check_info_queue.join(', '), 'awaiting_queue', _this.nicks_awaiting_info_queue);
        ...
        for(var nick in _this.nicks_awaiting_info_queue){
        	if(_this.nicks_awaiting_info_queue[nick] < now - 300 && _this.nicks_check_info_queue.indexOf(nick) < 0){
        		b.log.debug('4 (move back to check info queue) info_queue', _this.nicks_check_info_queue.join(', '), 'awaiting_queue', _this.nicks_awaiting_info_queue);
