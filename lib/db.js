...
module.exports = class DB{
    constructor(options){
        ...
        var new_path = __botdir + '/db/' + this.options.db_name + '.json';
    ...
    clean_db(){
        ...
        this.get_data('/', function(db_root){
            ...
            //b.log.debug(_this.options.db_name, db_root);
            ...
            _this.update('/', filter_empty(db_root), true, function(){
                b.log.info('Engaged the quantum ' + _this.options.db_name + ' database');
            });
        });
    }
