...
ACT.prototype.manage_arr = function(path, args, new_data){
    var type = args[0] === '-list' || args[0] === '-edit' || args[0] === '-delete' ? args[0] : '-add';
    var id = null;
    var new_data = type === '-edit' && new_data !== 'undefined' && new_data !== '' && new_data !== null ? new_data.replace(/^-edit\s\d+\s/, '') : new_data;
