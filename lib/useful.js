...
//ms if false, ignore milliseconds
USE.prototype.epoc_to_date = function(epoc, type){
    ...
    return month + '/' + day + '/' + year + ' ' + time + ' (' + getTimezone() + ')';
}
