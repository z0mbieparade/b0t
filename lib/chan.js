...
CHAN.prototype.message = function(nick, text, is_discord_user){
    ...
    //say the bots name
    if (text.indexOf(bot.nick) > -1 && this.config.respond_to_bot_name) { 
    ...
    //respond to command
        ...
        x.verify_command((is_discord_user ? _this.discord_users[nick] : _this.users[nick]), command, true, false, function(cmd){
            if(cmd !== false){
