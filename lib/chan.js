...
module.exports = class CHAN{
    ...
    init_chan(){
        ...
        db.get_data('/polls/' + _this.chan + '[-1]', function(poll){
    ...
    enter_msg(){
        ...
        if(this.config.speak_on_channel_join){
            ...
            if(enter_msg.length > 1 && enter_msg[0].toLowerCase() === 'qotd'){
                db.get_data('/topic', function(data){
                   if(data !== null){
    ...
    message(nick, text, is_discord_user){
    	var _this = this;
        ...
        if (text.match(new RegExp('^' + bot.nick)) !== null && this.config.respond_to_bot_name) { 
            ...
            if(command_args_org[0] == '-version') {
                ...
                b.users.owner(true, function(owner_nicks){
                    _this.SAY.say('owner(s): ' + c.rainbow(owner_nicks.join(', ')), 2, {ignore_bot_speak: true});
                    return;
                });
    ...
    action(nick, text, is_discord_user){
        var _this = this;
    ...
    get_all_users_in_chan_data(options, callback) {
        ...
        if(options.col === null){
            ...
            Object.keys(_this.users).forEach(function(nick) {
                b.users.get_user_data(nick, options, function(user_data){
                    if(user_data !== false){
                        rows[nick] = user_data;
                        count++;
                    }
    ...
    update_topic(){
        var _this = this;
        db.get_data('/topic', function(data){
            db.get_data('/pinned/'+_this.chan, function(pinned){
